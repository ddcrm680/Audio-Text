        ...
        <div className="flex flex-row px-[14px] md:flex-col lg:mx-auto lg:flex-row lg:items-center lg:justify-center lg:gap-8 lg:px-40 xl:justify-between">
          ...
          <div className="flex flex-1 items-center justify-end">
            <div>
              ...
              <nav
                id="navbarCollapse"
                className={`navbar absolute right-0 z-30 mt-2 w-[230px] rounded border border-[#d9d9d9] bg-white py-2 shadow-lg duration-300 md:visible md:static md:mt-0 md:w-auto md:border-none md:bg-transparent md:p-0 md:shadow-none lg:visible lg:static lg:w-auto lg:border-none lg:p-0 lg:opacity-100 dark:border-gray-600 dark:bg-[#1f2937] ${
                  navbarOpen
