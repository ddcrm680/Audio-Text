      ...
      >
        <div className="flex flex-row px-[14px] md:flex-col md:justify-center xl:mx-auto xl:flex-row xl:items-center xl:justify-between xl:gap-8 2xl:px-40">
          <div className="flex flex-shrink-0 items-center justify-between">
            ...
            <div
              className={`hidden md:flex md:items-center lg:hidden ${
                sticky
                  ? "py-5 md:pt-3 md:pb-0 lg:py-3"
                  : "py-5 md:pt-5 md:pb-0 lg:py-5"
              }`}
          ...
          <div className="flex flex-1 items-center justify-end md:justify-center lg:justify-end">
            ...
            >
              <ul className="flex flex-col md:flex-row md:items-center md:gap-12 md:overflow-x-scroll lg:justify-end lg:gap-4 xl:overflow-x-visible">
