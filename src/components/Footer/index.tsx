  ...
  return (
    <>
      <footer className="dark:bg-gray-dark footer relative z-10 bg-[#3b3e4f]">
        {/* Top Section */}
        <div className="mx-auto max-w-6xl px-5 py-12 md:px-8 lg:px-10 lg:py-14">
        ...
        <div className="bg-[#2f313e] py-8">
          <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-6 px-5 lg:flex-row lg:items-start lg:pr-20 lg:pl-10">
